...
/* The `import { TutiCurrentYear } from '@app/util'. */
import { TutiCurrentYear } from '@app/util';

/* `import styles from './styles/TutiFooterFinal.module.css'. */
import styles from './styles/TutiFooterFinal.module.css';
/* his component is then used in the `TutiFooterFinal` component to render a
horizontal line. */
...
export const TutiFooterFinal: FC = () => {
  ...
  return (
    /* Rendering a container `div` element with a class name of
    `tutiFooterFinal__container`. */
